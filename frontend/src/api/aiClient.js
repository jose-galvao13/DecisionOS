...
Os valores de upside são em MILHARES de euros (K€): por exemplo 800 significa €800K e 1200 significa €1,2M — nunca escrevas euros inteiros (800000). São estimados a partir dos resultados das ferramentas. Não incluas um nível de confiança — esse é calculado separadamente a partir dos dados.
...
Upside values are in THOUSANDS of euros (K€): for example 800 means €800K and 1200 means €1.2M — never write whole euros (800000). They are estimated from the tool results. Do not include a confidence score — that's computed separately from the data.
