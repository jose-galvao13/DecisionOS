...
- `LLM_API_KEY` — for `/api/advisor` and `/api/chat`. Any OpenAI-compatible provider; defaults to Groq (free) with `openai/gpt-oss-120b`. Optional: `LLM_BASE_URL`, `LLM_MODEL`.
